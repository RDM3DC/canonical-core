...
**Looking for notation?** See [docs/notation.md](docs/notation.md) for canonical symbols (⧉, πₐ, τ_coh, V_floor, etc.).

**Want the big picture?** Read [docs/index.md](docs/index.md) for how all five papers connect.
...
- **Version:** 0.1.0
- **Status:** Stable (foundational papers complete)
- **Next:** Adding figures, notation guide, and cross-paper glossary
...
- [ ] Complete glossary and notation guide
...
**Built by [RDM3DC](https://github.com/RDM3DC)** • **Version 0.1.0** • **2026-01-09**
